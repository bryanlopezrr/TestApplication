...
public class LoggedInActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String receivedUser = buffer.getString("key");
...
//        Toast.makeText(LoggedInActivity.this, receivedUser, Toast.LENGTH_LONG).show();
        ...
        Button theAnotherButton = (Button) findViewById(R.id.anotherButton);

        theAnotherButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = getPackageManager().getLaunchIntentForPackage("com.example.receiver");
                intent.putExtra("Comment", receivedUser);
